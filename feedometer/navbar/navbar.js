    ...
    children: [
      {
        ...
        sectionMeta: 'live feed',
        children: [
          { id: 'trending', title: 'Trending', href: 'home.html', icon: '🔥', badge: '142' },
          { id: 'search', title: 'Search', href: 'search.html', icon: '🔍', badge: '54' },
          { id: 'find-feeds', title: 'Find Feeds', href: 'find-feeds.html', icon: '📡', badge: 'Top' },
          { id: 'following', title: 'Following', href: 'following.html', icon: '⭐', badge: '' },
          { id: 'rss-reader', title: 'RSS Reader', href: 'rss-reader.html', icon: '📰', badge: '62' },
          { id: 'ai', title: 'AI', href: 'search.html?q=AI', icon: '🤖', badge: '89' },
          { id: 'markets', title: 'Markets', href: 'search.html?q=Markets', icon: '💰', badge: '54' },
          { id: 'world', title: 'World', href: 'top-stories.html', icon: '🌍', badge: '62' },
          { id: 'space', title: 'Space', href: 'search.html?q=Space', icon: '🚀', badge: '28' },
          { id: 'gaming', title: 'Gaming', href: 'read-rss.html', icon: '🎮', badge: '31' }
        ]
      },
      {
        id: 'workspaces',
        ...
        metaClass: 'meta-blue',
        children: [
          { id: 'rss-builder', title: 'RSS Builder', href: 'builder.html', icon: '🛠️', badge: 'Tool' },
          { id: 'ai-hardware', title: 'AI Hardware', href: 'find-feeds.html?q=AI%20Hardware', icon: '⚡', badge: '+3 new', badgeType: 'new' },
          { id: 'space-exp', title: 'Space Exp.', href: 'starred.html', icon: '🚀', badge: '12' },
          { id: 'agents', title: 'Agents', href: 'read-later.html', icon: '🤖', badge: '+5 new', badgeType: 'new' },
          { id: 'watchlists', title: 'Watchlists & Folders', href: 'watchlists.html', icon: '📁', badge: '4' }
        ]
      },
      {
        id: 'alerts',
        ...
        metaClass: 'meta-blue',
        children: [
          { id: 'openai-alert', title: 'OpenAI', href: 'find-sources.html?q=OpenAI', icon: '🟡', badge: '8', badgeType: 'alert' },
  ...
  function loadUserStorage() {
    try {
      state.favorites = JSON.parse(localStorage.getItem(getScopedKey(STORAGE_KEY_FAVS))) || [
        ...
        { id: 'search', title: 'Search', href: 'search.html', icon: '🔍', badge: '54' },
        { id: 'find-feeds', title: 'Find Feeds', href: 'find-feeds.html', icon: '📡', badge: 'Top' },
        { id: 'rss-reader', title: 'RSS Reader', href: 'index.html', icon: '📰', badge: '62' }
      ];
  ...
  function getEffectiveBadge(item) {
    if (item.id === 'following') {
      try {
        ...
        const guestList = JSON.parse(localStorage.getItem('feedometer_guest_subscriptions') || '[]');
      ...
      node.children.forEach(section => {
        html += `
          <div class="nav-section-header">
            ...
            ${section.sectionMeta ? `<span class="nav-section-meta ${section.metaClass || ''}">${section.sectionMeta}</span>` : ''}
          </div>
        `;
