...
(function () {
  ...
  function init() {
    ...
    const techUrl = (catalogData.sampleFeeds && catalogData.sampleFeeds.tech) || 'https://news.ycombinator.com/rss';
    if (feedParam && feedParam !== techUrl && !feedParam.includes('ycombinator')) {
