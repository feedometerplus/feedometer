 ...
 *
 */
export declare function connectToCDPBrowser(connectionTransport: ConnectionTransport, options: BrowserConnectOptions & ConnectOptions & {
    sessionId?: string;
}): Promise<CdpBrowser>;
/**
 * @public
 ...
 * @internal
 */
export declare const GUARDRAILS_HEADER = "cf-brapi-guardrails";
/**
